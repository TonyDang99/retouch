          ...
          <div className='box_main'>
            <div className='box_main-content'>
              ...
              <div className='box_item'>
                ...
                /> */}
                {/* <div className='test' contentEditable id="text" >
The World Before the Flood is an oil-on-canvas painting by 
</div>

<button className='box_requesticon1' id="bold_button" onClick={handleBoldClick}> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<button id="italic_button" onClick={handleItalicClick}>italic</button>
<button id="underline_button" onClick={handleUnderlineClick}>Underline</button> */}
                <div className='box_name'>
                  <p>Requests
                  </p>
                </div>
